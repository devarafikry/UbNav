...
//        deletePoint(addedPoint.getId());
    ...
    public AddPointCommand(View view, Snackbar s, AddCommandCallback addCommandCallback, DatabaseHelper mDbHelper, ArrayList<Path> paths, ArrayList<Point> points, Point selectedPoint, LatLng latLng, int pathCategory, int inOutCategory) {
